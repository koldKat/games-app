...
const documents = [
  ...
  { source: 'docs/platform-colors.md', output: 'public/docs/platform-colors.html', title: 'Platform Colors', description: 'Research sources and mapping rules for every built-in platform identity.' },
];
...
function pageTemplate(document, markdown) {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#080b10"><link rel="icon" href="/favicon.svg" type="image/svg+xml"><title>Game Kat·a·log // ${document.title}</title>
<style>
...
</style></head><body><header><strong>GAME KAT·A·LOG // DOCS</strong><span>${document.title}</span><nav><a href="/">APP</a><a href="/docs/">INDEX</a><a href="/docs/user-guide.html">USER</a><a href="/docs/technical.html">TECH</a><a href="/docs/platform-colors.html">COLORS</a></nav></header><div class="layout"><aside class="toc"><b>CONTENTS</b>${tocHtml}</aside><article class="content">${body}<p class="source">Generated from ${escapeHtml(document.source)}. Do not edit this HTML directly.</p></article></div><script type="module" src="/js/docs-navigation.js"></script></body></html>`;
}

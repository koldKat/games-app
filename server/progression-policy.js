...
const XP_EVENTS = Object.freeze({
  ...
  note_added: { amount: 5, label: 'Recorded a personal note' },
  ...
  catalogue_contribution: { amount: 30, label: 'Contributed to Kat·a·log' },
  ...
  multiplatform_collector: { amount: 40, label: 'Owned a title on multiple platforms' },
  format_double_dip: { amount: 30, label: 'Owned physical and digital editions' },
  platform_specialist: { amount: 150, label: 'Reached 25 games on one platform' },

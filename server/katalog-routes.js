...
function securityHeaders(response) {
  ...
  response.setHeader('Content-Security-Policy', "default-src 'self'; script-src 'self'; style-src 'self'; img-src 'self' blob: https://cdn.thegamesdb.net https://cdn.steamgriddb.com https://cdn2.steamgriddb.com https://images.igdb.com https://howlongtobeat.com; connect-src 'self'; frame-ancestors 'self'; base-uri 'self'; form-action 'self'");
}
